...
Forked from Google's example: https://support.google.com/a/answer/9250996?hl=en#scriptlet&zippy=%2Cconfigure-gcpw-with-the-devices-registry-settings

#>


# ADD DOMAINS HERE:
$domainsAllowedToLogin = "mydomain.com,mydomain2.com"
# Master Domain management TOKEN:
# This is where the device will be managed, irrespective of the domain the user is logging in with.
$mgmntToken = "####"
...
<# Set the master domain token for management #>
$mgmntRegistryPath = 'HKEY_LOCAL_MACHINE\Software\Policies\Google\CloudManagement'
$mgmntName = 'EnrollmentToken'
[microsoft.win32.registry]::SetValue($mgmntRegistryPath, $mgmntName, $mgmntToken)
